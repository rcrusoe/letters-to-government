...
class RepresentativesControllerTest < ActionController::TestCase
  ...
  test "should create representative" do
    assert_difference('Representative.count') do
      post :create, representative: { email: @representative.email, first_name: @representative.first_name, last_name: @representative.last_name, office: @representative.office, party: @representative.party, state: @representative.state }
    end
  ...
  test "should update representative" do
    patch :update, id: @representative, representative: { email: @representative.email, first_name: @representative.first_name, last_name: @representative.last_name, office: @representative.office, party: @representative.party, state: @representative.state }
    assert_redirected_to representative_path(assigns(:representative))
  end
